...
WORDS_PATH = os.path.join(BASE_DIR, "model", "saved_model", "words.pkl")
CLASSES_PATH = os.path.join(BASE_DIR, "model", "saved_model", "classes.pkl")
MODEL_PATH = os.path.join(BASE_DIR, "model", "saved_model", "model.pth")
INTENTS_PATH = os.path.join(BASE_DIR, "model", "dataset", "intents.json")
